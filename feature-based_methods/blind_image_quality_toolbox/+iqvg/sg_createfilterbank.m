...
if conf.domain==1
  ...
  for f0=freq,
    ...
    for o0=orientation,
      [filt,envelope,fhigh]=iqvg.sg_createfilterf2(f0,o0,conf.gamma,conf.eta,N,'use_envelope',1,'pf',conf.pf);
